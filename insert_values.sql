...
INSERT INTO orders (customer_id, order_date, status, total_amount) VALUES
    (1, '2024-03-01', 'completed', 1049.98),
    (2, '2024-03-05', 'completed', 129.99),
    (3, '2024-03-10', 'completed', 2199.98),
    (1, '2024-03-15', 'shipped', 79.99),
    (4, '2024-03-20', 'completed', 89.99),
    (5, '2024-03-25', 'pending', 174.98),
    (2, '2024-04-01', 'completed', 62.98),
    (6, '2024-04-05', 'shipped', 999.99),
    (3, '2024-04-10', 'completed', 149.99),
    (7, '2024-04-15', 'completed', 54.98);

-- Insert order items
INSERT INTO order_items (order_id, product_id, quantity, unit_price) VALUES
    -- Order 1: iPhone 15 + Nike Shoes
    (1, 1, 1, 999.99),
    (1, 4, 1, 129.99),
    -- Order 2: Nike Shoes
    (2, 4, 1, 129.99),
    -- Order 3: MacBook Pro + Wireless Headphones
    (3, 3, 1, 1999.99),
    (3, 12, 1, 199.99),
    ...
    (5, 8, 1, 89.99),
    -- Order 6: Tennis Racket + Basketball
    (6, 10, 1, 149.99),
    (6, 11, 1, 24.99),
    -- Order 7: Python Book + Great Gatsby
    (7, 6, 1, 49.99),
    (7, 7, 1, 12.99),
    -- Order 8: iPhone 15
    (8, 1, 1, 999.99),
    -- Order 9: Tennis Racket
    (9, 10, 1, 149.99),
    -- Order 10: Basketball + Garden Hose
    (10, 11, 2, 24.99),
    (10, 9, 1, 29.99);